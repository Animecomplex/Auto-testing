...
async def auto_rename_files(client, message):    
    ...
    # Check if the file is already being renamed or has been renamed recently
    ...
    if episode_number:
        ...
        try:
            ...
            # Forward the uploaded message to LOG_CHANNEL after sending to user
            await client.forward_messages(chat_id=LOG_CHANNEL, from_chat_id=message.chat.id, message_ids=sent_message.message_id)
